...
#
# Created: Tue Jan 17 11:26:21 2017
...
class Ui_TemplateSelector(object):
    def setupUi(self, TemplateSelector):
        ...
        self.gridLayout.addWidget(self.poiFieldComboBox, 7, 4, 1, 1)
        self.poiFieldLabel = QtGui.QLabel(TemplateSelector)
        self.poiFieldLabel.setObjectName(_fromUtf8("poiFieldLabel"))
        self.gridLayout.addWidget(self.poiFieldLabel, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.poiLayerLabel, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.poiLayerComboBox, 7, 1, 1, 2)
        ...
        self.suitableForComboBox.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.suitableForComboBox, 5, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.suitableForLabel, 5, 0, 1, 1)
